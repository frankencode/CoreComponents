...
Ref<SyntaxState> SyntaxDefinition::find(String text, int i, TokenFactory *tokenFactory) const
{
    return def_->find(text, i, tokenFactory);
}

Ref<SyntaxState> SyntaxDefinition::match(String text, int i, TokenFactory *tokenFactory) const
{
    return def_->match(text, i, tokenFactory);
}

Ref<StringList> SyntaxDefinition::split(String text) const
{
