...
{
public:
	typedef Map<NameHash, Ref<WireObject, Owner> > Properties;
	typedef List< Ref<WireObject, Owner> > Items;
	
	WireObject(String name, Ref<WireObject> prototype = 0, Ref<ByteArray> text = 0, int i0 = -1, int i1 = -1)
