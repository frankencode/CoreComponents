...
void* operator new(std::size_t size) throw (std::bad_alloc) { return ftl::Allocator::allocate(size); }
void* operator new[](std::size_t size) throw (std::bad_alloc) { return ftl::Allocator::allocate(size); }
void operator delete(void* data) throw() { return ftl::Allocator::free(data); }
void operator delete[](void* data) throw() { return ftl::Allocator::free(data); }
