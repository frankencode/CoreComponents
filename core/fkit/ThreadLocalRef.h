...
#ifndef FKIT_THREADLOCALREF_H
#define FKIT_THREADLOCALREF_H
...
public:
	ThreadLocalRef(T *b = 0) {
		...
		if (ret != 0)
			FKIT_PTHREAD_EXCEPTION("pthread_key_create", ret);
		if (b) set(b);
	}
