...
#ifndef FKIT_OBJECT_H
#define FKIT_OBJECT_H
...
FKIT_EXCEPTION(ReferenceException, Exception);
...
#ifndef NDEBUG
		if (refCount_ > 0)
			FKIT_THROW(ReferenceException, "Deleting object, which is still in use");
#endif
	}
