...
String Utf16Sink::Instance::SurrogatePairEncodingError::message() const
{
    return "UTF-16 error: encoding surrogate pairs is not allowed (0xD800..0xDFFF)";
}

String Utf16Sink::Instance::ByteOrderMarkEncodingError::message() const
{
    return "UTF-16 error: encoding the Byte Order Mark is not allowed (0xFEFF, 0xFFFE)";
}

String Utf16Sink::Instance::LargeCodePointEncodingError::message() const
{
