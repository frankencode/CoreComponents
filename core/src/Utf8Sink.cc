...
void Utf8Sink::Instance::write(uchar_t ch)
{
...
String Utf8Sink::Instance::SurrogatePairEncodingError::message() const
{
    return "UTF-8 error: encoding of surrogate pairs is not allowed (0xD800..0xDFFF)";
}

String Utf8Sink::Instance::NonCharacterEncodingError::message() const
{
    return "UTF-8 error: encoding of non-characters is not allowed (0xFDD0..0xFFFE, 0x*FFF(E|F))";
}

String Utf8Sink::Instance::LargeCodePointEncodingError::message() const
{
