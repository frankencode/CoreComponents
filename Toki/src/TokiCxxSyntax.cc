...
struct TokiCxxSyntax::State final: public TokiHighlightingSyntax::State
{
...
TokiCxxSyntax::TokiCxxSyntax()
{
    initOnce<State>();
}

const SyntaxRule &TokiCxxSyntax::commentLine() const
{
    return me().commentLine_;
}

const SyntaxRule &TokiCxxSyntax::commentText() const
{
    return me().commentText_;
}

const TokiCxxSyntax::State &TokiCxxSyntax::me() const
{
